...
if __name__ == "__main__":
    ...
    train_images = [row[0] for row in train_dataset]
    ...
    val_images = [row[0] for row in validation_dataset]
    validation_dataset = DeepFakesDataset(val_images, validation_labels, config['model']['image-size'], mode='validation')
